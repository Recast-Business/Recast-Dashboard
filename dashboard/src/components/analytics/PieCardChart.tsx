...
// Round-2 performance: this is the recharts-heavy half of PieCard,
// split out so it can be React.lazy-loaded from the thin wrapper in
// PieCard.tsx. recharts' Pie/Legend/Tooltip combo doesn't tree-shake
// down small (unlike Sparkline's minimal usage elsewhere), and every
// AnalyticsPanel that renders one of these starts collapsed — so
// there's no reason to pay for recharts until someone actually
// expands a panel.
export default function PieCardChart({ title, description, data, asCurrency = true, height = 240 }: PieCardProps) {
